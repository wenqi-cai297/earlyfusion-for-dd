...
if __name__ == "__main__":
    ...
    parser.add_argument("--diversity_only", action="store_true", default=False, help="use condense but only with diversity")
    parser.add_argument("--representative_only", action="store_true", default=False, help="use condense but only with representative")
